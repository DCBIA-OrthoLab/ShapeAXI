...
class SaxiClassification(LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        group.add_argument('--hidden_dim_att', type=int, help='Hidden dimension for attention layer', default=64)
...
class SaxiRing(LightningModule):
    ...
    def create_network(self, side):
        ...
        if self.hparams.subdivision_level == 3:
            ...
            raise "Subdivision level not supported, you have to choose between 1, 2 or 3"
...
class SaxiRing_QC(pl.LightningModule):
    def __init__(self, **kwargs):
...
class SaxiD(LightningModule):
    ...
    @staticmethod
    def add_model_specific_args(parent_parser):
        group = parent_parser.add_argument_group("Saxi decoder only")
