...
# line 204 int32/64 and pad_verts_faces
...
class TeethDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.test_ds = TeethDataset(self.df_test, self.mount_point, surf_column=self.surf_column, surf_property=self.surf_property, transform=self.test_transform)
